...
function NavBar() {
  return (
    ...
    <div className="fixed z-50 flex-wrap sm:justify-start sm:flex-nowrap w-full">
      <header className=" flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 dark:bg-neutral-800 border-b border-gray-200 dark:border-neutral-700 ">
