...
export default function MonthWiseSalesComparison(props: any) {
    ...
    useEffect(() => {
        ...
        // fetch(`${import.meta.env.VITE_API_BACKEND_URL}/api/month-wise-sales-comparison?yyyymm=${yyyymm}&location=${selectedStore?.LOCATION_ID}`)
        fetch(`/api/month-wise-sales-comparison.json`)
